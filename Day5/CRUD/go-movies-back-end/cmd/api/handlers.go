...
func (app *application) InsertMovie(w http.ResponseWriter, r *http.Request) {
	...
	movie = app.getPosterFromRemoteAPI(movie)
...
func (app *application) getPosterFromRemoteAPI(movie models.Movie) models.Movie {
	...
	var responseObject movieAPIResponse
